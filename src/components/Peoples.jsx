...
const Peoples = () => {
  document.title = "CAPSTAB | Peoples";
    ...
    <div className="absolute lg:pl-[17%] lg:w-[100%] w-full h-full">
      ...
      <div className="flex flex-col gap-5 p-4 sm:p-8">
        ...
        <div className="flex flex-wrap justify-between items-center gap-3">
          <h1 className="text-white text-2xl sm:text-3xl font-bold">Peoples</h1>
        </div>

        {/* People List with Infinite Scroll */}
        <InfiniteScroll
        ...
        >
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {peoples.map((person, index) => (
              <Cards key={index} data={[person]} title="person" />
            ))}
          </div>
        </InfiniteScroll>
      </div>
...
//                 <h1 className='text-white text-3xl font-bold'>Peoples</h1>
